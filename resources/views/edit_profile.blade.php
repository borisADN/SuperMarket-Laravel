		...
		<div class="overlay-container">
			<div class="overlay">
				<div class="overlay-left">
					...
					<!-- <h1>Bonjour!</h1> -->
					<p>Renseignez alors vos nouvelles informations</p>
					<h1>OU</h1>
					<button ><a href="{{ route('home') }}">Annuler</a></button>
				</div>
				<div class="overlay-right">
					<h1>Bonjour ,Mon Ami</h1>
					<h3>Si Vous etes ici ,c'est que vous voulez modifier votre profile</h3>
					<!-- <h3> C'est le moment de nous rejoindre !</h3> -->
					<button id="signUp">Continuer</button>
				</div>
			</div>
		</div>
	</div>
